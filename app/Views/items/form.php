        ...
        <div class='col-xs-8'>
            <div class="fileinput <?= $logo_exists ? 'fileinput-exists' : 'fileinput-new' ?>" data-provides="fileinput">
                ...
                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 100px; max-height: 100px;">
                    <img data-src="holder.js/100%x100%" alt="<?= lang('Items.image') ?>" src="<?= $image_path ?>"
                ...
                <div>
                    ...
                    <a href="#" class="btn btn-default btn-sm fileinput-exists"
                        data-dismiss="fileinput"><?= lang('Items.remove_image') ?></a>
                </div>
            </div>
        </div>
    </div>
...
<script type="application/javascript">
    ...
    $('#new').click(function () {
        dialog_support.set_clicked($(this).attr('id'));
        $('#item_form').submit();
    });

    $('#submit').click(function () {
        dialog_support.set_clicked($(this).attr('id')); // Track which button was clicked
        $('#item_form').submit(); // Actually submit the form
    });
