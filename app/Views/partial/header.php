...
<head>
    ...
    <?php if (ENVIRONMENT == 'development' || get_cookie('debug') == 'true' || $request->getGet('debug') == 'true') : ?>
        ...
        <link rel="stylesheet" href="resources/css/bootstrap-0d7b0f1415.autocomplete.css">
        <link rel="stylesheet" href="resources/css/invoice-250684151a.css">
        <link rel="stylesheet" href="resources/css/ospos_print-971242c338.css">
        <link rel="stylesheet" href="resources/css/ospos-78b8695e40.css">
        <link rel="stylesheet" href="resources/css/popupbox-87ebf46806.css">
        <link rel="stylesheet" href="resources/css/receipt-8eb6bdbe11.css">
        <link rel="stylesheet" href="resources/css/register-b9d91a0e16.css">
        <link rel="stylesheet" href="resources/css/reports-70e6a5904f.css">
        <!-- endinject -->
        <!-- inject:debug:js -->
        ...
        <script src="resources/js/manage_tables-129ea185df.js"></script>
        <script src="resources/js/nominatim-43f85c3d91.autocomplete.js"></script>
        <!-- endinject -->
    <?php else : ?>
        <!--inject:prod:css -->
...
<body>
    <div class="wrapper">
        <div class="topbar" style="background-color: rgb(36, 163, 74)">
            <div class="container">
        ...
        <div class="navbar navbar-default" role="navigation" style="background-color: rgb(12, 99, 38);">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">Ramchemical</a>
                </div>
